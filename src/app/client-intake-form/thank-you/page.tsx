...
function Page() {
    return (
        <div className="bg-[#040404] pt-30">
            <div className="flex items-center justify-center translate-y-22 max-md:w-11/12">
                <div className="text-center max-w-[620px]">
                    ...
                    <p className="lg:text-[40px] text-[32px] capitalize mb-3">for completing this form</p>
