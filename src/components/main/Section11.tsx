        ...
        <section className="mt-50">
            <div className="flex lg:flex-row flex-col-reverse gap-10 items-center justify-between gap-x-20 mx-auto max-w-[1400px] w-11/12">
                ...
                <div>
                    ...
                    <p className="font-inter font-light text-lg max-w-[600px] mt-5 text-whitisch">Private Processing™ is the rising high level community of e-commerce millionaires and billionaires.</p>
                    <p className="font-inter font-light text-lg max-w-[600px] mt-5 text-whitisch">With an upcoming series of connection events in the most exclusive locations around the world.</p>
                    <p className="font-inter font-light text-lg max-w-[600px] mt-5 text-whitisch">We create human relationships that last a lifetime.</p>
