        ...
        <section className="lg:my-50 mt-25">
            <div className="flex lg:flex-row flex-col gap-10 items-center justify-between gap-x-20 mx-auto max-w-[1400px] w-11/12">
                <div>
                    ...
                    <p className="font-inter font-light text-lg max-w-[600px] mt-5 text-whitisch">A recent article on
                    ...
                    <p className="text-lg text-whitisch mt-5"><span
                        className="font-bold text-white">@Samuel Aziz Boubaous</span> — Founder of Private
                        Processing™</p>
                </div>
                <div className="relative max-lg:hidden">
                    <Image src={"/img/img_10.png"} alt={"Aziz sitting into the cat"} width={542} height={596}/>
                    <p className="absolute bottom-0 p-5 text-lg max-w-[400px] text-whitisch"><span
