    ...
    return (
        <section className="pt-20 lg:mt-20" id="solutions">
            <div className="max-w-[800px] mx-auto text-center w-11/12">
                <p className="lg:text-[52px] text-[32px] lg:leading-12 leading-10 tracking-tighter font-light">All your <span className="text-gold font-medium font-manrope">Information in one place</span>
                </p>
                <p className="text-[#ACAFB9] lg:text-[20px] text-[18px] max-lg:font-light mt-5 !tracking-[-0.38px]">Say goodbye to endless KYC. Once your profile is created
            ...
            <div className="mt-10 w-11/12 mx-auto lg:hidden relative">
                <Image className="w-fit mx-auto scale-105" src="/img/img_15.png" alt="Brand Images" width={570} height={443} />
            </div>
