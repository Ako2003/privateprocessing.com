    ...
    return (
        <section className="mt-20">
            <div className="max-w-[800px] mx-auto text-center">
                ...
                <p className="text-[#ACAFB9] text-[20px]">Say goodbye to endless KYC. Once your profile is created on the platform, you can apply to multiple processors with one click.</p>
            </div>
            <div className="mt-10">
