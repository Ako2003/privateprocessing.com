...
export default function Section5() {
    return (
        <section className="pt-20 mt-10 max-w-[1200px] mx-auto w-11/12">
            ...
            <div className="flex justify-between mt-10 xl:flex-row flex-col gap-y-10">
                {/*  Card 1  */}
                ...
                >
                    <p className="text-white font-medium text-lg mb-2.5">Risk-Aware Assessment</p>
                ...
                >
                    ...
                    <div className="p-5">
                        <p className="text-white font-medium text-lg mb-2.5">Specialized Processor Matching</p>
                ...
                >
                    <p className="text-white font-medium text-lg mb-2.5">Long-Term Partnership</p>
