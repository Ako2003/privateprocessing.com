        ...
        <section className="lg:pt-30 lg:mt-20 pt-25" id="shared-values">
            <div className="flex lg:flex-row flex-col gap-10 items-center justify-between gap-x-20 mx-auto max-w-[1200px] w-11/12">
                <div>
                    ...
                    <p className="font-semibold text-lg max-w-[470px] mt-5">Private Processing™ clients are used to
                        excellent service.</p>
                    ...
                    <p className="font-inter font-light text-lg max-w-[470px] text-whitisch">They value their time
                        more than money and understand that they don’t need to be an expert in every field
                        themselves.</p>
                    <p className="font-inter font-light text-lg max-w-[470px] mt-5 text-whitisch">Instead they enjoy
                        working with smart people and building a network of elite entrepreneurs with whom they can
                        collaborate. </p>
                    <p className="font-inter font-light text-lg max-w-[470px] mt-5 text-whitisch">They make fast
                        decisions, know what they want and are not afraid of spending money</p>
                </div>
